...
chkComer := interfaz.AddCheckbox('ys+5 vcComer', ' Comer: 1')
ahkComer := interfaz.AddHotkey('Disabled w12 ys vaComer', '1')
...
chkBeber := interfaz.AddCheckbox('ys+5 vcBeber', ' Beber:')
ahkBeber := interfaz.AddHotkey('Disabled w12 ys vaBeber', '2')
